...
class ThanhToanController extends Controller
{
    ...
    public function thanhToan(Request $request)
    {
        ...
        foreach ($listOrder as $key => $value) {
            ...
            $maKM = isset($value["MaKM"]) ? $value["MaKM"] : null;
        ...
        Log::info($tongtien);
        $phantramKM= isset($khuyenmai->phantramKM) ? $khuyenmai->phantramKM : 0;
        $hoadon->TienKM = $phantramKM * $tongtien / 100;
        Log::info($hoadon->TienKM);
        $tongtien  = $tongtien  - $phantramKM * $tongtien / 100;
        Log::info($tongtien);
        $hoadon->MaKM = $maKM;
        if ($khachhang->role != "khachhang") {
