...
import Item1 from "../../images/products/menu-1.png";
import Item2 from "../../images/products/menu-2.png";
import Item3 from "../../images/products/menu-3.png";
import Item4 from "../../images/products/menu-4.png";
import Item5 from "../../images/products/menu-5.png";
import Item6 from "../../images/products/menu-6.png";
  ...
  return (
    <div className="h-[100vh] bg-[#010103] w-full">
      <div className="flex bg-[#010103] items-center justify-center w-full  pt-12">
        <Title className="text-[#fff] text-[3rem] font-bold ">
          Sản phẩm
        </Title>
      </div>
            ...
            if (item.id % 2 == 0) {
              return (
                ...
                >
                  ...
                  <div
                    id={item.id}
                    className="border-[1px] h-[6.2rem] w-[30rem] border-solid border-[#fff] pl-[5rem] py-6 pr-8 flex justify-between"
                  >
                    <Text
                      id={item.id}
