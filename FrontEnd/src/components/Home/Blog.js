...
export default function Blog() {
  ...
  return (
    <div className="container w-full max-w-[1100px] mx-auto h-[auto]">
      <div className="flex-col py-8 ">
        <Title className="text-[#E7596D] w-[16rem] mb-0 md:mt-20 pt-5 mx-auto text-center">
          Bloomsy Blog
        </Title>
        <Paragraph className="text-[#E7596D] w-[18rem] mb-0 mx-auto text-center text-[1.2rem]">
          Một bó hoa, một câu chuyện
        </Paragraph>
      </div>
          ...
          return (
            <Col id={item.id} className="mt-5" span={8}>
              <Card
                ...
                size="small"
                hoverable
                className="  mx-5 my-5 h-[auto] rounded-lg"
                bordered={true}
                cover={
                  <div id={item.id} className="h-[12rem] w-[auto] overflow-hidden ">
                    <Img
                      id={item.id}
