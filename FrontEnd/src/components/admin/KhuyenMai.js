...
const KhuyenMai = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (
      ...
      console.log("1234", khuyenmaiInfo);
      ...
      <Row className="w-full mb-8 flex items-center border-b-[0.01rem] border-solid border-[#000] border-opacity-30 pb-16 ">
        ...
        <div className="w-full flex justify-end mt-5 ">
          <Button
            ...
            className="w-24 h-8 rounded-lg text-white bg-[#E7596D] hover:bg-[#146d4d] flex items-center justify-center"
          >
            Xóa
          </Button>
          <Button
            onClick={handleSubmitUpdateKhuyenMai}
            className="w-24 h-8 rounded-lg text-white bg-[#E7596D] hover:bg-[#146d4d] flex items-center justify-center mx-2"
          >
            Áp dụng
          </Button>
        </div>
