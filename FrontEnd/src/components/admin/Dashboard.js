...
const Dashboard = () => {
  ...
  console.log("kieulam", hoadonData);
  console.log("kieulam2", muahangData);
  return (
    <>
      <div className="w-full max-w-4xl mx-auto">
        <div className="w-[90%] flex justify-between mt-10 items-center">
          <div>
            ...
            <p className="mb-0 opacity-70">Tháng 1 - Tháng 6 năm 2024</p>
          </div>
          <div>
            <button
              onClick={(e) => handleClickChangeChart(e)}
              name="bar"
              className={`py-[2px] px-3 border-solid border-[1px] border-[#000] rounded-sm focus:bg-[#E7596D] focus:text-[#fff] transition-all  ease-in-out delay-300 ${isSelected == "bar" ? "bg-[#E7596D] text-[#fff]" : ""
                } `}
            >
              Bar
            </button>
            <button
              onClick={(e) => handleClickChangeChart(e)}
              name="line"
              className="mx-1 py-[2px] px-3 border-solid border-[1px] border-[#000] rounded-sm focus:bg-[#E7596D] focus:text-[#fff] transition-all  ease-in-out delay-300 "
            >
              Line
            </button>
            <button
              onClick={(e) => handleClickChangeChart(e)}
              name="pie"
              className="py-[2px] px-3 border-solid border-[1px] border-[#000] rounded-sm focus:bg-[#E7596D] focus:text-[#fff] transition-all  ease-in-out delay-300 "
            >
              Pie
            </button>
          </div>
        ...
        <div className="w-[90%] flex justify-between mt-10 items-center">
          ...
          <div>
            ...
            <button
              onClick={(e) => handleClickChangeChartMH(e)}
              name="pie"
              className={`py-[2px] px-3 border-solid border-[1px] border-[#000] rounded-sm focus:bg-[#E7596D] focus:text-[#fff] transition-all  ease-in-out delay-300 ${isSelectedMH == "pie" ? "bg-[#E7596D] text-[#fff]" : ""
                } `}
            >
              Pie
            </button>
