...
const HoaDonDetail = () => {
  ...
  return (
    <div className="container h-full max-w-[1024px] mx-auto pb-40 mt-20 ml-5">
        ...
        <Col className="h-full mb-10 " span={16}>
          <Row className="w-full h-full border-[0.01rem] py-4 border-solid border-[#CFCFCF]  flex items-center justify-center mb-2">
            <Col span={11}>
              <div className="flex">
                <p>Đơn đặt:</p>
                <p className="ml-3 font-semibold text-[#e7596d]">
                  {billDetail.id}
                </p>
              </div>
              <div className="flex">
            ...
            <Col span={11}>
              ...
              {billDetail.isOnline != 1 && (
                <>
                  <div className="flex">
                    <p>Tên Nhân Viên:</p>
                    <p className="ml-3 font-semibold mb-[55px] text-[#e7596d]">
                      Lê Thị Kiều Lam
                    </p>
                  </div>
                  <div className="flex">
                    <p></p>
                    <p className="ml-3 font-semibold text-[#e7596d]"></p>
                  </div>
                  <div className="flex">
                    <p></p>
                    <p className="ml-3 font-semibold text-[#e7596d]"></p>
        ...
        <Col className="h-full " span={8}>
          ...
          <div className="flex w-[90%] mx-auto justify-between mt-4">
            <p
              ...
              className="text-[#e7596d] cursor-pointer underline-offset-1 underline mb-0"
            >
              In hóa đơn
            </p>
            <Link to="/admin/hoadon">
              <p className="text-[#e7596d] cursor-pointer underline-offset-1 underline mb-0">
                Danh sách hóa đơn
              </p>
            </Link>
          </div>
