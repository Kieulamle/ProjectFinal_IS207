  ...
  return (
    <>
      <div className="absolute  top-6 right-10">
        <Button
          onClick={handlePrint}
          className="bg-[#e7596d] text-white font-semibold px-2  rounded-md"
        >
          In hóa đơn
        </Button>
      </div>
      ...
      >
        <p className="text-center text-xl text-[#e7596d] font-semibold mb-1">
          BLOOMSY FLOWER SHOP
        </p>
        ...
        <p className="text-center text-xl text-[#e7596d] font-semibold mb-0">
          Hóa đơn thanh toán
        </p>
        ...
        <div className="flex justify-between w-[35%]">
          ...
          <p className="text-left font-semibold text-base mb-0 w-[110px] mb-5 ">
            {hoadonDetail.hoten}
          </p>
        </div>
        <Table
        ...
        <div className="flex justify-end w-full items-center ml-6 border-b-[2px] border-solid pb-3 border-[#000]">
          ...
          <p className="text-left font-semibold text-base w-[108px] ml-5 mb-0 ">
            {tienKM && tienKM.toLocaleString() || 0 + " VND"}
          </p>
        </div>
        <div className="flex justify-end w-full items-center ml-6 mt-3 ">
        ...
        <div className="flex justify-center w-full items-center ml-6 mt-3 ">
          <p className="text-center text-[#e7596d] text-lg font-semibold  mb-0 ">
            BLOOMSY FLOWER SHOP xin chào và hẹn gặp lại !
          </p>
        </div>
      </div>
    </>
