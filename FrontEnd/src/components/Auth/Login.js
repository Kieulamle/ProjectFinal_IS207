      ...
      <Col className="h-[90vh] bg-[#FFFFFF] rounded-md" span={10} offset={7}>
        <Col span={16} offset={4}>
          <div className="flex-col w-full mt-8 ">
            <Title className="text-center text-[#E7596D] font-SignIn font-extrabold text-[1.8rem] w-full h-[2.8rem]  mb-0">
              WELCOME BACK!
            </Title>
          ...
          <div className="flex-col mt-4">
            ...
            <div className="flex items-center w-full my-2">
              <input
                type="checkbox"
                className="accent-[#E7596D] w-[0.7rem] h-[0.7rem] rounded-md cursor-pointer"
              />
