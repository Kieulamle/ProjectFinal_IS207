...
import menu1 from "../images/products/order1.png";
import icon_tea from "../images/products/tea.jpg";
      ...
      <div className="  items-center mx-auto ">
        <Row className="w-full pb-10" gutter={35}>
          ...
          <Col span={12}>
              ...
              <>
                ...
                <div className="flex mt-2">
                  <div className="relative h-[2.4rem] w-[7rem] flex items-center border-[0.01rem] rounded-[0.3rem] border-solid  ">
                    ...
                    <label
                      for="sizeVua"
                      className={`cursor-pointer w-full h-full flex ${sizeVuaActive ? "bg-[#146d4d]" : ""
                        }`}
                    >
                      <p
                        className={`text-[0.9rem] mx-auto text-center my-auto ${sizeVuaActive
                          ? "bg-[#146d4d] text-[#fff]"
                          : "text-[#000]"
                          }`}
                      >
                  ...
                  <div className="relative h-[2.4rem] w-[7rem] flex items-center border-[0.01rem] rounded-[0.3rem] border-solid ml-3  ">
                    ...
                    <label
                      for="sizeLon"
                      className={`cursor-pointer w-full h-full flex ${sizeLonActive ? "bg-[#146d4d]" : ""
                        } `}
                    >
                      <p
                        className={`text-[0.9rem] mx-auto text-center my-auto ${sizeLonActive
                          ? "bg-[#146d4d] text-[#fff]"
                          : "text-[#000]"
                          }`}
                      >
            ...
            <Button
              ...
              className="bg-[#e7596d] w-full rounded-md py-[1.3rem] flex justify-center items-center text-[#fff] text-[0.7rem] mt-7 font-bold"
            >
              Thêm vào giỏ hàng
            </Button>
          </Col>
        ...
        >
          ...
          <Text className="mt-[-2.5rem]">
            Bó hoa là một tác phẩm nghệ thuật tự nhiên, là sự hòa quyện của màu sắc,
            hương thơm và vẻ đẹp tinh tế. Được tạo ra từ sự kết hợp hài hòa của các
            loại hoa tươi tắn và lá cây xanh mát, bó hoa này không chỉ là một sản phẩm
            trang trí tuyệt vời mà còn là biểu tượng của tình yêu, sự quý phái và sự tươi mới.
          </Text>
        </Row>
