  ...
  return (
    <div className="container mx-auto max-w-[1124px] pt-20 pb-16">
      ...
      <Row className="w-full">
        <Col span={11}>
          <Title className="mb-0 text-[#E7596D] " level={2}>
            Liên hệ Bloomsy
          </Title>
          ...
          <div className="mt-3">
            ...
            <p className="mb-0 opacity-70">bloomsyshop@gmail.com</p>
          </div>
          <div className="mt-3">
          ...
          <div className="mt-3">
            ...
            <p className="mb-0 opacity-70">+(84) 123 456 789</p>
          </div>
        </Col>
        <Col span={12} offset={1}>
          <Title className="mb-0 text-[#E7596D] " level={2}>
            Gửi thông tin cho Bloomsy
          </Title>
          <Input
            size="medium"
            name="email"
          ...
          <div className="w-full mt-4 flex justify-end ">
            <Button className="bg-[#E7596D] px-5 rounded-md py-[1rem] flex justify-center items-center text-[#fff] text-[0.7rem] font-bold">
              Gửi
            </Button>
          </div>
        </Col>
