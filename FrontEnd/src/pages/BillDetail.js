...
const BillDetail = () => {
  ...
  useEffect(() => {
    const FetchHoaDon = async () => {
      ...
      let giakm = (total * selectedKhuyenmai?.phantramKM || 0) / 100;
      setGiaKm(giakm);
      total -= giakm;
        ...
        <Col className="h-full mb-10 " span={16}>
          <Row className="w-full h-full border-[0.01rem] py-4 border-solid border-[#CFCFCF]  flex items-center justify-center mb-2">
            <Col span={11}>
              ...
              <div className="flex">
                <p>Thanh Toán:</p>
                <p className="ml-3 font-semibold text-[#e7596d]"> COD</p>
              </div>
            </Col>
            <Col span={11}>
              <div className="flex">
            ...
            <div className="w-[82%] ">
              <Button
                className={`${detailBill.TrangThai == "Chưa xác nhận" && "bg-[#EC870E]"
